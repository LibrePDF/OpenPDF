...
public class JFreeChartExample {
    ...
    public static void main(String[] args) {
        ...
        convertToPdf(getBarChart(), 400, 600, args[0] + "/barchart.pdf");
        convertToPdf(getPieChart(), 400, 600, args[0] + "/piechart.pdf");
        convertToPdf(getXYChart(), 400, 600, args[0] + "/xychart.pdf");
    }
