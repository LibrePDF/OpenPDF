 ...
 * @author blowagie
 */
public class XandYCoordinates extends AbstractSample {
    ...
    public static void main(String[] args) {
        XandYCoordinates templates = new XandYCoordinates();
        templates.run(args);
    }
    ...
    public void render(String path) {
        System.out.println("DirectContent :: Coordinates :: X and Y coordinate system");
