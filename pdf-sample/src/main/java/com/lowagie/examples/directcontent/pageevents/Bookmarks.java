...
public class Bookmarks extends AbstractSample {
    ...
    public static void main(String[] args) {
        Bookmarks templates = new Bookmarks();
        templates.run(args);
    }
    ...
    public void render(String path) {
        ...
        System.out.println("DirectContent :: PageEvents :: Bookmarks");

        // tag::generation[]
        // step 1: creation of a document-object
        try (Document document = new Document(PageSize.A6)) {
    ...
    // tag::pageEvent[]
    static class BookmarkPageEvent extends PdfPageEventHelper {
        /**
