...
public class Events extends AbstractSample {
    ...
    public void render(String path) {
        ...
        try (Document document = new Document(PageSize.A4, 80, 50, 30, 65)) {
            ...
            parser.parse(Events.class.getClassLoader().getResource("playRomeoJuliet.xml").openStream(), new Events().getXmlHandler(document));
    ...
    static class MyPageEvents extends PdfPageEventHelper {
         ...
         *
         * @see PdfPageEventHelper#onGenericTag(PdfWriter, Document, Rectangle, String)
         */
         ...
         *
         * @see PdfPageEventHelper#onChapter(PdfWriter, Document, float, Paragraph)
         */
    ...
    static class RomeoJulietMap extends TagMap {
        ...
        RomeoJulietMap() throws IOException {
            super(Events.class.getClassLoader().getResource("tagmapRomeoJuliet.xml").openStream());
