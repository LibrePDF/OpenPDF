...
public class ImageSequence {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Objects :: Images :: Image Sequence");
        ...
        try {
            ...
            PdfWriter.getInstance(document, new FileOutputStream(args[0] + "/notInSequence.pdf"));
            PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(args[0] + "/inSequence.pdf"));
