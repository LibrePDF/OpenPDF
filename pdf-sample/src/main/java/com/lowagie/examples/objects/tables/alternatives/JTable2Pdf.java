...
public class JTable2Pdf extends JFrame {
    ...
    public static void main(String[] args) {
        System.out.println("Objects :: Tables :: Alternatives :: Printing a JTable");
        System.setProperty("java.awt.headless", "true");
        JTable2Pdf frame = new JTable2Pdf(args);
        frame.pack();
    ...
    private void print() {
        ...
        try {
            PdfWriter writer =
                    PdfWriter.getInstance(document, new FileOutputStream(args[0] + "/jTable.pdf"));
