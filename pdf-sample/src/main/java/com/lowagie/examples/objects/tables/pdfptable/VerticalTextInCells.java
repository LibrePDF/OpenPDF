...
public class VerticalTextInCells {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Objects :: Tables :: PdfTable :: Vertical text in cells");
        // step1
        Document document = new Document(PageSize.A4, 50, 50, 50, 50);
        try {
            // step2
            PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(args[0] + "/VerticalText.pdf"));
            // step3
            document.open();
            // step4
