...
public class ColumnObjects {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Objects :: Columns :: Columns and objects");

        // step 1: creation of a document-object
        Document document = new Document(PageSize.LETTER, 90, 54, 72, 72);
        try {
            // step 2: we create a writer that listens to the document
            PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(args[0] + "/columnobjects.pdf"));
            ...
            cb.stroke();
            Image img = Image.getInstance(ColumnObjects.class.getClassLoader().getResource("cover.png"));
