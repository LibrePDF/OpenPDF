...
public class OutlineActions {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Objects :: Bookmarks :: Outlines with actions");
        ...
        try {
            // step 2:
            PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream(args[0] + "/OutlineActions.pdf"));
            PdfWriter.getInstance(remote, new FileOutputStream(args[0] + "/remote.pdf"));
            // step 3:
