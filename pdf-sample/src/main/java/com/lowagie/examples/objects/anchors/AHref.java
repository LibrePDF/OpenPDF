...
public class AHref {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Objects :: Anchors :: The Anchor object");

        // step 1: creation of a document-object
        Document document = new Document();
        try {
            // step 2:
            PdfWriter.getInstance(document, new FileOutputStream(args[0] + "/AHref.pdf"));
            HtmlWriter.getInstance(document, new FileOutputStream(args[0] + "/AHref.html"));
