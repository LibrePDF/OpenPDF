...
public class RemoteGoto {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Objects :: Anchors :: Remote goto (URLs and local destinations in another document)");
        ...
        try {
            ...
            // step 2:
            PdfWriter writerA = PdfWriter.getInstance(document, new FileOutputStream(args[0] + "/DocumentA.pdf"));
            PdfWriter writerB = PdfWriter.getInstance(document, new FileOutputStream(args[0] + "/DocumentB.pdf"));
