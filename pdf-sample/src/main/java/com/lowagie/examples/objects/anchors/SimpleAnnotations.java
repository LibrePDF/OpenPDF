...
public class SimpleAnnotations {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Objects :: Anchors :: Simple Annotations");
        ...
        try {
            ...
            PdfWriter writer1 = PdfWriter.getInstance(document1,
                    new FileOutputStream(args[0] + "/SimpleAnnotations1.pdf"));
            PdfWriter writer2 = PdfWriter.getInstance(document2,
                    new FileOutputStream(args[0] + "/SimpleAnnotations2.pdf"));
            // step 3:
