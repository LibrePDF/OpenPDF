...
public class SpecificCells {
    ...
    public static void main(String[] args) {
        System.out.println("Objects :: Tables :: Alternatives :: Adding cells at a specific position");
        // step 1: creation of a document-object
        Document document = new Document();
        try {
            // step 2: creation of the writer
            PdfWriter.getInstance(document, new FileOutputStream(args[0] + "/specificcells.pdf"));
