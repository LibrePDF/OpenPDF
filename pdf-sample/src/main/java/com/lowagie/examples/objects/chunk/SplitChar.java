...
public class SplitChar implements SplitCharacter {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Objects :: Chunk :: Split Character");
        ...
        try {
            ...
            PdfWriter.getInstance(document,
                    new FileOutputStream(args[0] + "/SplitChar.pdf"));
    ...
    /**
     * @see SplitCharacter#isSplitCharacter(int, int, int, char[], PdfChunk[])
     */
