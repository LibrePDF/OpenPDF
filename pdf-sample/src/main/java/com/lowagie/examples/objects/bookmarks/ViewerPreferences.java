...
public class ViewerPreferences {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Objects :: Bookmarks :: Viewer Preferences");
        ...
        try {
            ...
            PdfWriter writer1 = PdfWriter.getInstance(document,
                    new FileOutputStream(args[0] + "/TwoColumnLeft.pdf"));
            PdfWriter writer2 = PdfWriter.getInstance(document,
                    new FileOutputStream(args[0] + "/HideMenuToolbar.pdf"));
            PdfWriter writer3 = PdfWriter.getInstance(document,
                    new FileOutputStream(args[0] + "/FullScreen.pdf"));
            PdfWriter writer4 = PdfWriter.getInstance(document,
                    new FileOutputStream(args[0] + "/WithTitle.pdf"));
            PdfWriter writer5 = PdfWriter.getInstance(document,
                    new FileOutputStream(args[0] + "/NoScaling.pdf"));
            // step 3:
