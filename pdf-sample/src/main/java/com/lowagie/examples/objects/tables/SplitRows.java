...
public class SplitRows {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Objects :: Tables :: Split rows");
        // step1
        ...
        try {
            ...
            PdfWriter.getInstance(document1,
                    new FileOutputStream(args[0] + "/SplitRowsBetween.pdf"));
            PdfWriter.getInstance(document2,
                    new FileOutputStream(args[0] + "/SplitRowsWithin.pdf"));
            PdfWriter.getInstance(document3,
                    new FileOutputStream(args[0] + "/OmitRows.pdf"));
            // step3
            document1.open();
            document2.open();
            document3.open();
