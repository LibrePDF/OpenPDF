...
public class VerticalPositionMark implements DrawInterface, Element {
    ...
    /**
     * @see org.openpdf.text.pdf.draw.DrawInterface#draw(org.openpdf.text.pdf.PdfContentByte, float, float, float,
     * float, float)
     */
    ...
    /**
     * @see org.openpdf.text.Element#process(org.openpdf.text.ElementListener)
     */
    ...
    /**
     * @see org.openpdf.text.Element#type()
     */
    public int type() {
    ...
    /**
     * @see org.openpdf.text.Element#isContent()
     */
    ...
    /**
     * @see org.openpdf.text.Element#getChunks()
     */
