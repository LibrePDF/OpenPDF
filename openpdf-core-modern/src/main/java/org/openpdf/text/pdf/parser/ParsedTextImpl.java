...
public abstract class ParsedTextImpl implements TextAssemblyBuffer {
    ...
    /**
     * We track a vector representing our baseline, left->right, so that calculations of line- change can be accurate,
     * even with 0-length words (representing lone spaces, when those are rendered by the PDF).
     */
    private Vector baseline;

    /**
     * @param text       characters to be rendered for this string
     * @param startPoint Initial rendering spot on baseline
     * @param endPoint   ending render position on baseline
     * @param baseline   vector representing baseline (needed for 0-length strings)
     * @param ascent     font ascent above baseline
     * @param descent    font descent below the baseling
     * @param spaceWidth What is the width of the space in this font....
     */
     ...
     * {@inheritDoc}
     *
     * @see org.openpdf.text.pdf.parser.ParsedText#getText()
     */
    @Override
    ...
    /**
     * @return a vector in User space representing the end point of the text (i.e. the starting point of the text plus
     * the width of the text, transformed by the applicable transformation matrices)
     */
    ...
    /**
     * @return true if this was extracted from a string containing spaces, in which case, we assume further splitting is
     * not needed.
     */
