...
public class MarkedUpTextAssembler implements TextAssembler {
     ...
     * {@inheritDoc}
     *
     * @see org.openpdf.text.pdf.parser.TextAssembler#process(Word, String)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.openpdf.text.pdf.parser.TextAssembler#endParsingContext(String)
     */
    @Override
    ...
    /**
     * @see org.openpdf.text.pdf.parser.TextAssembler#reset()
     */
    @Override
    public void reset() {
        result.clear();
     ...
     *
     * @see org.openpdf.text.pdf.parser.GraphicsState
     * @see org.openpdf.text.pdf.parser.Matrix
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.openpdf.text.pdf.parser.TextAssembler#setPage(int)
     */
    @Override
     ...
     * {@inheritDoc}
     *
     * @see org.openpdf.text.pdf.parser.TextAssembler#getWordId()
     */
    @Override
