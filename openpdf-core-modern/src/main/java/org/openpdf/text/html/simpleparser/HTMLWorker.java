...
package org.openpdf.text.html.simpleparser;

import static org.openpdf.text.html.Markup.parseLength;
...
import org.openpdf.text.FontProvider;
...
import org.openpdf.text.utils.NumberUtilities;
...
public class HTMLWorker implements SimpleXMLDocHandler, DocListener {
    ...
    public void startElement(String tag, Map<String, String> style) {
        ...
        try {
            ...
            if (tag.equals(HtmlTags.UNORDEREDLIST)) {
                ...
                skipText = true;
                cprops.addToChain(tag, style);
                org.openpdf.text.List list = new org.openpdf.text.List(false);
                try {
            ...
            if (tag.equals(HtmlTags.ORDEREDLIST)) {
                ...
                skipText = true;
                cprops.addToChain(tag, style);
                org.openpdf.text.List list = new org.openpdf.text.List(true);
                try {
                    list.setIndentationLeft(Float.parseFloat(cprops.getProperty("indent")));
                } catch (Exception e) {
                    list.setAutoindent(true);
    ...
    public void endElement(String tag) {
        ...
        try {
            ...
            if (tag.equals(HtmlTags.UNORDEREDLIST)
                ...
                Object obj = stack.pop();
                if (!(obj instanceof org.openpdf.text.List)) {
                    stack.push(obj);
                    return;
                }
                if (stack.empty()) {
                    ...
                    if (peek instanceof org.openpdf.text.List) {
                        ((org.openpdf.text.List) peek).add((org.openpdf.text.List) obj);
                    } else {
            ...
            if (tag.equals(HtmlTags.LISTITEM)) {
                ...
                if (!(list instanceof org.openpdf.text.List)) {
                    stack.push(list);
                    return;
                }
                ListItem item = (ListItem) obj;
                ((org.openpdf.text.List) list).add(item);
    ...
    /**
     * @see org.openpdf.text.DocListener#setMarginMirroring(boolean)
     * @since 2.1.6
     */
