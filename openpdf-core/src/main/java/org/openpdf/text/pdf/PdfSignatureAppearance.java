...
public class PdfSignatureAppearance {
     ...
     */
    public org.openpdf.text.pdf.PdfName getFilter() {
        return filter;
    }
     ...
     */
    public org.openpdf.text.Rectangle getPageRect() {
        return pageRect;
    }
    ...
    org.openpdf.text.pdf.ByteBuffer getSigout() {
        return sigout;
    }

    void setSigout(org.openpdf.text.pdf.ByteBuffer sigout) {
        this.sigout = sigout;
    }
     ...
     */
    public org.openpdf.text.pdf.PdfDictionary getCryptoDictionary() {
    ...
    public void setCryptoDictionary(
            org.openpdf.text.pdf.PdfDictionary cryptoDictionary) {
     ...
     */
    public org.openpdf.text.pdf.PdfStamper getStamper() {
        return stamper;
    }

    void setStamper(org.openpdf.text.pdf.PdfStamper stamper) {
     ...
     */
    public org.openpdf.text.pdf.PdfSigGenericPKCS getSigStandard() {
        return sigStandard;
    }
