 ...
 * <p>
 * When using variable borders ({@link org.openpdf.text.Rectangle#isUseVariableBorders isUseVariableBorders()} == true),
 ...
 *
 * @see org.openpdf.text.Rectangle
 * @see org.openpdf.text.Cell
 * @see PdfLine
 * @see PdfTable
 */
...
public class PdfCell extends Rectangle {
     ...
     *
     * @param side the side to check.  One of the side constants in {@link org.openpdf.text.Rectangle}
