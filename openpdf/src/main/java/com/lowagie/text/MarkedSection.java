...
public class MarkedSection extends MarkedObject<Section> {
    /** This is the title of this section. */
    protected MarkedObject<Paragraph> title = null;
     ...
     *
     * @param    index    index at which the specified element is to be inserted
     * @param    e       an object of type <CODE>Paragraph</CODE>, <CODE>List</CODE> or <CODE>Table</CODE>=
     * @throws    ClassCastException if the object is not a <CODE>Paragraph</CODE>, <CODE>List</CODE> or <CODE>Table</CODE>
     */
     ...
     * @deprecated use <CODE>add(Element e)</CODE>
     */
    @Deprecated
    public boolean add(Object o) {
        return element.add(o);
    }
     ...
     */
    public boolean addAll(Iterable<? extends Element> collection) {
     ...
     * @return    <CODE>true</CODE> if the action succeeded, <CODE>false</CODE> if not.
     * @throws    ClassCastException if one of the objects isn't a <CODE>Paragraph</CODE>, <CODE>List</CODE>, <CODE>Table</CODE>
     * @deprecated use <CODE>addAll(Iterable<? extends Element> collection)</CODE> instead
     */
    @Deprecated
    ...
    public MarkedSection addSection(float indentation, int numberDepth) {
        MarkedSection section = element.addMarkedSection();
    ...
    public MarkedSection addSection() {
        return element.addMarkedSection();
    }
     ...
     */
    public void setTitle(MarkedObject<Paragraph> title) {
        this.title = title;
    }
     ...
     * @since    iText 2.0.8
     */
    public MarkedObject<Paragraph> getTitle() {
        Paragraph result = Section.constructTitle(title.element, element.numbers, element.numberDepth, element.numberStyle);
        MarkedObject<Paragraph> mo = new MarkedObject<>(result);
    ...
    public void setNumberDepth(int numberDepth) {
        element.setNumberDepth(numberDepth);
    }
    ...
    public void setIndentation(float indentation) {
        element.setIndentation(indentation);
    }
    ...
    public void setBookmarkOpen(boolean bookmarkOpen) {
         element.setBookmarkOpen(bookmarkOpen);
    }
    ...
    public void setTriggerNewPage(boolean triggerNewPage) {
          element.setTriggerNewPage(triggerNewPage);
    }
    ...
    public void setBookmarkTitle(String bookmarkTitle) {
          element.setBookmarkTitle(bookmarkTitle);
    }
