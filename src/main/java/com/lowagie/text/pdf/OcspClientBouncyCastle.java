...
import old.org.bouncycastle.ocsp.BasicOCSPResp;
import old.org.bouncycastle.ocsp.CertificateID;
import old.org.bouncycastle.ocsp.CertificateStatus;
import old.org.bouncycastle.ocsp.OCSPException;
import old.org.bouncycastle.ocsp.OCSPReq;
import old.org.bouncycastle.ocsp.OCSPReqGenerator;
import old.org.bouncycastle.ocsp.OCSPResp;
import old.org.bouncycastle.ocsp.SingleResp;
...
public class OcspClientBouncyCastle implements OcspClient {
    ...
    private static OCSPReq generateOCSPRequest(X509Certificate issuerCert,
        ...
        // Add provider BC
        Security.addProvider(new old.org.bouncycastle.jce.provider.BouncyCastleProvider());
        ...
        values.add(new X509Extension(false, new DEROctetString(
                new DEROctetString(PdfEncryption.createDocumentId())
                        .getEncoded())));
        ...
        try {
            ...
            if (basicResponse != null) {
                ...
                if (responses.length == 1) {
                    ...
                    } else if (status instanceof old.org.bouncycastle.ocsp.RevokedStatus) {
