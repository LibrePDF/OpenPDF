...
import old.org.bouncycastle.asn1.DERString;
...
public class PdfPKCS7 {
    ...
    public PdfPKCS7(PrivateKey privKey, Certificate[] certChain, CRL[] crlList,
        ...
        if (digestAlgorithm == null)
            throw new NoSuchAlgorithmException(
                    MessageLocalization.getComposedMessage(
                            "unknown.hash.algorithm.1", hashAlgorithm));
    ...
    public byte[] getEncodedPKCS7(byte secondDigest[], Calendar signingTime,
        ...
        try {
            ...
            // digest
            if (tsaClient != null) {
                byte[] tsImprint = MessageDigest.getInstance("SHA-1").digest(
                        digest);
