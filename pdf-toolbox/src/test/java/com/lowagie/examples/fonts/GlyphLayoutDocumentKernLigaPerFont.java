...
public class GlyphLayoutDocumentKernLigaPerFont {
    ...
    public static void test(String fileName) throws Exception {
        ...
        // For RTL-Scripts: LayoutProcessor.enable(java.awt.Font.LAYOUT_LEFT_TO_RIGHT);
